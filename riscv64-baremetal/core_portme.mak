...
PORT_CFLAGS = -march=rv32im -mabi=ilp32 -O2 -mcmodel=medany -static -ffunction-sections -fno-delete-null-pointer-checks -std=gnu99 -fno-common -nostartfiles -lm -lgcc -T $(PORT_DIR)/multithread/link_map.txt
...
PORT_SRCS = $(PORT_DIR)/multithread/init.s $(PORT_DIR)/core_portme.c  $(PORT_DIR)/ee_printf.c  $(PORT_DIR)/cvt.c $(PORT_DIR)/lib/*.o #$(PORT_DIR)/crt.S $(PORT_DIR)/syscalls.c
# Flag: LOAD
